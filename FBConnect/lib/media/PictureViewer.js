 ...
 * 
 * 
 * @author Andrew Tuttle (Origin Date-11/20/2008)
 */
Groove.include("./lib/media/Picture.js");
...
function PictureViewer(fullSize){
	...
	this.container.css = Groove.Stylesheet.teatherElement(this.container).style;
	this.container.main.css = Groove.Stylesheet.teatherElement(this.container.main).style;
	this.container.debug.css = Groove.Stylesheet.teatherElement(this.container.debug).style;
	...
	this.container.css.width = this.container.fullSize+"px";
	this.container.css.padding = "0px";
	this.container.css.marginTop = "0px";
	this.container.css.marginBottom = "0px";
	this.container.css.marginLeft = "auto";
	this.container.css.marginRight = "auto";
	this.container.css.height = this.container.fullSize+20+"px";
	
	this.container.main.css.width = this.container.fullSize+"px";
	this.container.main.css.padding = "0px";
	this.container.main.css.margin = "0px";
	this.container.main.css.height = this.container.fullSize+"px";
	this.container.main.css.backgroundColor = "#ffffff";
	
	this.container.debug.css.width = this.container.fullSize+"px";
	this.container.debug.css.padding = "0px";
	this.container.debug.css.margin = "0px";
	...
	this.addPicture = function(src){
		...
		newPicContainer.css.style.position = "absolute";
		...
		newPicContainer.className = "floatLeft";
		newPicContainer.css.style.textAlign = "center";
		newPicContainer.css.style.top = "0px";
		//newPicContainer.css.style.display = "table-cell";
		//newPicContainer.css.style.vertcalAlign = "middle";
		...
		newPic.onload = function(){
			...
			if(this.width > this.height){
				...
				//this.css.style.verticalAlign = "middle";
				...
				this.css.style.height = 100*(((this.container.container.fullSize/this.width) * this.height)/this.container.container.fullSize)+"%";//yeah heh sorry quicker to do it one line
			}else{
				//this.css.style.height = "100%";
				this.css.style.width = 100*(((this.container.container.fullSize/this.height) * this.width)/this.container.container.fullSize)+"%";//yeah heh sorry quicker to do it one line
		...
		newPicContainer.click = function(){
			this.onclick = null;
			//if(this.container.fullPicView){this.container.fullPicView = false;}else{this.container.fullPicView=true;}
			if(this.container.fullPicView){
				this.css.style.height = "300px";
				this.firstChild.css.style.marginTop = (100*Math.floor(Math.floor(this.container.fullSize-((this.container.fullSize/this.width) * this.height))/2)/this.container.fullSize)+"%";
			}else{
			}
		
	
		}
		newPicContainer.onclick = newPicContainer.click;
